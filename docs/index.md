...
Start with an idea in [Jupyter Labs](https://jupyter.org) or [Node-RED](https://nodered.org). When you're ready, wrap it as a containerized app and share it with the OpenBOS community — no boilerplate, no plumbing.
