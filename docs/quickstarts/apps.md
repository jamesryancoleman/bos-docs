...
The easiest way to build an app is to clone a template and start building. We recommend: [example-bospy-app](https://github.com/jamesryancoleman/example-bospy-app).
